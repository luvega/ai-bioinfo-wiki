...
- 清理脚本：[`scripts/convert/clean_aidd_subtitles.py`](../../scripts/convert/clean_aidd_subtitles.py)
- 术语校正词典：[`materials/raw/aidd_bioinformatics/TERMS.md`](../../materials/raw/aidd_bioinformatics/TERMS.md)
- 章节索引：[`materials/raw/aidd_bioinformatics/INDEX.md`](../../materials/raw/aidd_bioinformatics/INDEX.md)
...
- AIDD 字幕中常见机翻错误已在 [TERMS.md](../../materials/raw/aidd_bioinformatics/TERMS.md) 列出。
