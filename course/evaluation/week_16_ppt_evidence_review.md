...
Week 16 storyboard 的教学定位合理：面向药学本科生训练 QC、UMAP、cluster、marker 和 spatial 图形的阅读边界；但进入正式 PPTX 前必须解决公开图形来源、参数说明和 marker/空间区域解释边界。
...
| P1 | visual examples | QC/UMAP/marker/spatial 图若来自外部材料，需要确认数据来源和授权 | 优先使用自生成示意图或公开许可图，并在图注中说明来源 |
...
| spatial domain 代表空间模式候选 | needs source/figure review | 需核图形来源和术语 |

## Next Checks

1. 准备可公开展示的 QC、UMAP、marker 和 spatial 示例图，或改用自生成教学示意图。
