...
# Upstream: https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/introduction/advanced_data_structures_and_frameworks.ipynb
...
# %% [markdown]
# This chapter assumes familiarity with AnnData and scanpy from the [previous chapter](fundamental_data_structures_and_frameworks.ipynb).
