...
upstream_path: jupyter-book/introduction/interoperability.ipynb
...
To address this, the `MuData` object—introduced in the [analysis frameworks and tools chapter](https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/introduction/{ref}`analysis frameworks and tools chapter <introduction:analysis-frameworks>`)—extends `AnnData` for multimodal datasets.
