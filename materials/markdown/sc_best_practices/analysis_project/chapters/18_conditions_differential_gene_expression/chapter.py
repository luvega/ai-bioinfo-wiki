...
# Upstream: https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/conditions/differential_gene_expression.ipynb
...
# 
# To do so, we create a more complex [desgin matrix](design-syntax) and then use contrasts to specify the conditions of interest.
