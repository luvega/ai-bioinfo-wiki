...
title: "Clustering"
upstream_path: jupyter-book/cellular_structure/clustering.ipynb
...
[rapids-singlecell](https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/introduction/rapids_singlecell.ipynb) provides `rsc.tl.leiden` with the same signature and routinely runs 50–100× faster than the CPU implementation.
```
...
More details can be found in the [dimensionality reduction chapter](https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/preprocessing_visualization/dimensionality_reduction.ipynb).
