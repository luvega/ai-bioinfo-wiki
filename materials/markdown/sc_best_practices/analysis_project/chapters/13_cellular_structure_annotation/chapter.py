...
# Title: Annotation
# Upstream: https://github.com/theislab/single-cell-best-practices/blob/735f26fd270b3beceb4ba79f4a556c912192fe83/jupyter-book/cellular_structure/annotation.ipynb
...
# %%
# Upstream code cell: 166
adata_emb.obs["cell_type"] = None

# %%
# Upstream code cell: 167
...
# %%
# Upstream code cell: 175
sc.set_figure_params(figsize=(8, 8))

# %%
# Upstream code cell: 176
sc.pl.umap(
    emb_ref_query,
    color=["cell_type"],
    sort_order=False,
...
# %%
# Upstream code cell: 189
sc.set_figure_params(figsize=(5, 5))

# %%
# Upstream code cell: 190
