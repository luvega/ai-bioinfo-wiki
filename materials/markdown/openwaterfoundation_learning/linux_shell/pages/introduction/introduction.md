...
original_url: "https://learn.openwaterfoundation.org/owf-learn-linux-shell/introduction/introduction.html"
repo_url: "https://github.com/OpenWaterFoundation/owf-learn-linux-shell"
commit_sha: 4cf789ec9b3ae88a6f8be218dcd4dadcf86ac18d
source_path: "mkdocs-project/docs/introduction/introduction.md"
source_blob: "https://github.com/OpenWaterFoundation/owf-learn-linux-shell/blob/4cf789ec9b3ae88a6f8be218dcd4dadcf86ac18d/mkdocs-project/docs/introduction/introduction.md"
...
The [Installing Shell Software](../install/install.md) documentation explains how to install Linux shell software (even on Windows).
...
(more on that in the [Shell Script Basics](../shell-script-basics/shell-script-basics.md) section).
